            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about-img">
                        ...
                        <div class="shoes-img"><img src="../frontend/images/shoes-img1.png"></div>
                ...
                <div class="col-md-6">
                    <div class="about-img2">
                        <div class="shoes-img2"><img src="../frontend/images/shoes-img2.png"></div>
                        <p class="sport_text">Men Sports</p>
                        <div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
                        <div class="star_icon">
                            <ul>
...
<div class="collectipn_section_3 layuot_padding">
    <div class="container">
        <div class="racing_shoes">
            <div class="row">
                <div class="col-md-8">
                    <div class="shoes-img3"><img src="../frontend/images/shoes-img3.png"></div>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="best_shoes">
                    ...
                    <div class="shoes_icon"><img src="../frontend/images/shoes-img4.png"></div>
                    <div class="star_text">
                        <div class="left_part">
                            <ul>
                                <li><a href="#"><img src="../frontend/images/star-icon.png"></a></li>
            ...
            <div class="col-sm-4">
                <div class="best_shoes">
                    <p class="best_text">Best Shoes </p>
                    <div class="shoes_icon"><img src="../frontend/images/shoes-img5.png"></div>
                    <div class="star_text">
                        <div class="left_part">
                            <ul>
                                <li><a href="#"><img src="../frontend/images/star-icon.png"></a></li>
            ...
            <div class="col-sm-4">
                <div class="best_shoes">
                    <p class="best_text">Best Shoes </p>
                    <div class="shoes_icon"><img src="../frontend/images/shoes-img6.png"></div>
                    <div class="star_text">
                        <div class="left_part">
                            <ul>
                                <li><a href="#"><img src="../frontend/images/star-icon.png"></a></li>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="best_shoes">
                    ...
                    <div class="shoes_icon"><img src="../frontend/images/shoes-img7.png"></div>
                    <div class="star_text">
                        <div class="left_part">
                            <ul>
                                <li><a href="#"><img src="../frontend/images/star-icon.png"></a></li>
            ...
            <div class="col-sm-4">
                <div class="best_shoes">
                    <p class="best_text">Sports Shoes</p>
                    <div class="shoes_icon"><img src="../frontend/images/shoes-img8.png"></div>
                    <div class="star_text">
                        <div class="left_part">
                            <ul>
                                <li><a href="#"><img src="../frontend/images/star-icon.png"></a></li>
            ...
            <div class="col-sm-4">
                <div class="best_shoes">
                    <p class="best_text">Sports Shoes</p>
                    <div class="shoes_icon"><img src="../frontend/images/shoes-img9.png"></div>
                    <div class="star_text">
                        <div class="left_part">
                            <ul>
                                <li><a href="#"><img src="../frontend/images/star-icon.png"></a></li>
